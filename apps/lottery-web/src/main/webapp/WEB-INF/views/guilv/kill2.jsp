...
<body> 
         ...
         <div class="col-lg-12 col-xs-12 col-sm-12  "    >
          ...
          <div class="nav-tabs-custom">
            ...
            <li class="active"><a href="#quilvQuery5" data-toggle="tab" onclick="quilvQuery(5);" > 五星 </a></li>
            <li ><a href="#quilvQuery0" data-toggle="tab" onclick="quilvQuery(0);" > 二位</a></li>
             <li><a href="#quilvQuery1" data-toggle="tab" onclick="quilvQuery(1);"  > 三位 </a></li>
              <!-- <li class="active"><a href="#quilvQuery6" data-toggle="tab" onclick="quilvQuery(6);" > 一星 </a></li>  -->
            
              
                  
                
                  <li><a href="#quilvQuery3" data-toggle="tab" onclick="quilvQuery(3);" > 极限 </a></li> 
                  
                <!--    <li><a href="#quilvQuery4" data-toggle="tab" onclick="quilvQuery(4);" > 个 </a></li> -->
               ...
               <div class="chart tab-pane" id="quilvQuery2" ></div>
                ...
                <div class="chart tab-pane" id="quilvQuery4" ></div>
                 <div class="chart tab-pane" id="quilvQuery5" ></div>
                  <div class="chart tab-pane  active" id="quilvQuery6" ></div>
                   <div class="chart tab-pane" id="quilvQuery7" ></div>
                    <div class="chart tab-pane" id="quilvQuery8" ></div>
            </div>
          </div>
          <!-- /.nav-tabs-custom -->
	   ...
	   function quilvQuery(type){
		 ...
		 function  ajaxQueryList(){
		  ...
		  $("#quilvQuery"+type).append(qu); 
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/system/ajax/guilv/kill2",                                      
  		 dataType: "html", 
