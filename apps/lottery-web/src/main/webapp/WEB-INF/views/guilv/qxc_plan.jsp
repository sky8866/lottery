          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs " >
             ...
             <li><a href="#quilvQuery2" data-toggle="tab" onclick="quilvQuery(2);"  > 36组 </a></li>
                ...
                <li><a href="#quilvQuery3" data-toggle="tab" onclick="quilvQuery(3);" > 1296组 </a></li>  
                  <li><a href="#quilvQuery4" data-toggle="tab" onclick="quilvQuery(4);" > 2401组</a></li>    
                      <li><a href="#quilvQuery6" data-toggle="tab" onclick="quilvQuery(6);" > 参考 </a></li>      
            ...
            <div class="tab-content no-padding">
              ...
              <div class="chart tab-pane " id="quilvQuery4"   >
              </div>
	   ...
	   function quilvQuery(type){
		 ...
		 function  ajaxQueryList(){
		  ...
		  $("#quilvQuery"+type).append(qu); 
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/system/ajax/guilv/qxc/plan",                                      
  		 dataType: "html", 
