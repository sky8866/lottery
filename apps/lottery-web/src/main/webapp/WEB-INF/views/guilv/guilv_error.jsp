         ...
         <div class="col-lg-12 col-xs-12 col-sm-12 ">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs " >
              ...
              <li class="active"><a href="#quilvErrorQuery0" data-toggle="tab" onclick="quilvErrorQuery(0);" > 头 </a></li>
              <li><a href="#quilvErrorQuery1" data-toggle="tab" onclick="quilvErrorQuery(1);"  > 百 </a></li>
                <li><a href="#quilvErrorQuery2" data-toggle="tab" onclick="quilvErrorQuery(2);" > 十 </a></li>
                  <li><a href="#quilvErrorQuery3" data-toggle="tab" onclick="quilvErrorQuery(3);" > 尾 </a></li>
                     
                   <li class="pull-right"><a href="#" class="text-muted" data-toggle="modal"  data-target="#impallModal"><i class="glyphicon glyphicon-search"></i> 断规</a></li>       
	   ...
	   function quilvErrorQuery(type){
		 ...
		 function  ajaxQueryList(){
		  ...
		  var qi=$("#qi").val();
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/system/ajax/guilv/error_query",                                      
  		 dataType: "html", 
