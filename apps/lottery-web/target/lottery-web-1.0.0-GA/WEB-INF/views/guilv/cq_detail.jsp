		...
		<table class="table  table-bordered"
			...
			<c:forEach items="${lsList}" var="entry" varStatus="statu">
				...
				<tr >
                  ...
                  <c:if test="${entry.qi==lottery.qi&&guilv.type==4 }">  yuanjiao   </c:if>"
                   style="width: 15px;  height: 15px;  ">
                   ${entry.number5 }
                   </div>
					</td>
			...
			<tr style="  border-bottom: 1px red solid;" > 
				...
				<c:if test="${guilv.type==0 }"> 
					<div class="aap" style="border-color:orange;"></div>
				 <div style="float:left;   position:absolute; "> <div class="yuanjiao " >${guilv.value }万</div><c:if  test="${ !empty type }"><div style="color:red;   ">[${type }]</div></c:if></div>
					 </c:if>
				</td>
				<td > 
				<c:if test="${guilv.type==1 }">
				<div class="aap" style="border-color:orange;"></div>
				 <div style="float:left;   position:absolute; "> <div class="yuanjiao " >${guilv.value }千</div><c:if  test="${ !empty type }"><div style="color:red;   ">[${type }]</div></c:if></div>
				   </c:if>
				 </td>
				<td  > 
			 ...
			 <div style="float:left;   position:absolute; "> <div class="yuanjiao " >${guilv.value }百</div><c:if  test="${ !empty type }"><div style="color:red;   ">[${type }]</div></c:if></div>
				...
				<td ><c:if  test="${guilv.type==4 }">
				<div class="aap" style="border-color:orange;"></div>
				 <div style="float:left;   position:absolute; "> <div class="yuanjiao " >${guilv.value }个</div><c:if  test="${ !empty type }"><div style="color:red;   ">[${type }]</div></c:if></div>
				 </c:if></td>
