...
<body> 
  ...
  <option value="0">全程全对</option>
  <option value="500">连对500期以上</option> 
  <option value="1000">连对1000期以上</option> 
   <option value="1500">连对1500期以上</option>   
	   ...
	   function quilvQuery(type){
		 ...
		 function  ajaxQueryList(){
		  ...
		  $("#quilvQuery"+type).append(qu);
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/system/ajax/guilv/limit2",                                      
  		 dataType: "html", 
  		   data: {type:type,openId:openid,even:even,qi:qi},
