         ...
         <div class="col-lg-12 col-xs-12 col-sm-12  "    >
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs " >
              ...
              <li class="active"><a href="#quilvQuery0" data-toggle="tab" onclick="quilvQuery(0);" > 万 </a></li>
              <li><a href="#quilvQuery1" data-toggle="tab" onclick="quilvQuery(1);"  > 千 </a></li>
                <li><a href="#quilvQuery2" data-toggle="tab" onclick="quilvQuery(2);" > 百 </a></li>
                  <li><a href="#quilvQuery3" data-toggle="tab" onclick="quilvQuery(3);" > 十 </a></li>
                    <li><a href="#quilvQuery4" data-toggle="tab" onclick="quilvQuery(4);" > 个 </a></li>
                    <li><a href="#quilvQuery5" data-toggle="tab" onclick="quilvQuery(5);" > 计划 </a></li>
	   ...
	   function quilvQuery(type){
		 ...
		 function  ajaxQueryList(){
		  ...
		  $("#quilvQuery"+type).append(qu); 
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/system/ajax/guilv/kill",                                      
  		 dataType: "html", 
