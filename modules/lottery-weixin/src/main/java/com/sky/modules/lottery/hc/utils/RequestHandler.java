...
//		System.out.println("UrlEncode后 packageValue=" + packageValue);
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		sb.append("key=" + WeChatConfig.PARTNERKEY_OLD);
	...
	public static String genAppSign(List<NameValuePair> params) {
		...
		sb.append("key=");
		sb.append(WeChatConfig.PARTNERKEY_OLD);
		
		System.out.println("sb:"+sb);
		
		String res = WeChatUtil.getMessageDigest(sb.toString().getBytes()).toUpperCase();
	...
	public static void main(String[] args) {
		String res = WeChatUtil.getMessageDigest("abcdabcdddddbca110022".getBytes()).toUpperCase();
	 ...
	 * 微信公众号端生成签名
	 */
	public String createSign_weixin(SortedMap<String, String> packageParams) {
		StringBuffer sb = new StringBuffer();
		Set es = packageParams.entrySet();
		Iterator it = es.iterator();
		while (it.hasNext()) {
