...
@Entity
@Table(name = "t_guilv_single_double_old")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class GuilvSingleDoubleOld extends IdLongEntity {
	
	
	public GuilvSingleDoubleOld(){}
	public GuilvSingleDoubleOld(GuilvSingleDouble g){
