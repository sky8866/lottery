...
@Entity
@Table(name = "t_cqssc_guilv")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CqsscGuilv extends IdLongEntity {
	...
	public String getTypeLottery() {
		return typeLottery;
	}

	public void setTypeLottery(String typeLottery) {
