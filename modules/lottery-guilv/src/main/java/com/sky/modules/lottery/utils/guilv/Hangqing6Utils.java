...
public class Hangqing6Utils {
 
	public static void main(String[] args) {
 
		String url="http://m.500.com/info/kaijiang/tjssc";
	...
	public static Long  getHangqing3(TjsscLotteryService service) {
		 Long count=0l;
		try{
		...
		for(int i=83;i>=0;i--){
		      try{
		    	  String qi=	ele1.get(0).getElementsByTag("td").get(i*3).getElementsByTag("td").text();
					 ...
					 qi=qi.substring(0, 8)+qi.substring(9, 11);
					 count=Long.parseLong(qi);
					   TjsscLottery ly= service.findReport("qi", count);
