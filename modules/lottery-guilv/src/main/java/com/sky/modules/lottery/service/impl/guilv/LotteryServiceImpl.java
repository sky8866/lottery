...
@Autowired private LotteryDao reportDao;
	...
	@Override
	public QueryResult<Lottery> findList(PageView<Lottery> pv,
	 ...
	 @Cacheable(value="departCache") 
     public QueryResult<Lottery> findPageReport(PageView<Lottery> pv,String hql, Object[] queryParams){
	...
	@Override
	public QueryResult<Lottery> findReports(PageView pv, String query,String depquery,Long myuserid,Long userid,String starttime,String endtime) {
	    String date="1=1 ";
        if (myuserid!=null) {
	...
	public Lottery findLottery() {
		 String hql="select  u from Lottery u  order by u.qi desc";  
		 Lottery lottery=this.reportDao.findHQL(hql);
		return lottery;
	}
