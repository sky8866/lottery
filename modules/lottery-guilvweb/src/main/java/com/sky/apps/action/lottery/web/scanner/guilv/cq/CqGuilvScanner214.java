...
@Service("CqGuilvScanner214") 
public class CqGuilvScanner214 implements QueryComm{
						...
						for(int type=0;type<=4;type++){ 
							 for(int number=6;number<=6;number++){
								 ...
								 for(int addition=4;addition<=4;addition++){
								    ...
								    CqLotteryUtils.setQuery(addition, buchang, type, CqNumCountUtils.getCount(addition, buchang, f, number), f, 1, number, lotteryService, guilvService, sbr,true,cocuntService,conditionService);	
