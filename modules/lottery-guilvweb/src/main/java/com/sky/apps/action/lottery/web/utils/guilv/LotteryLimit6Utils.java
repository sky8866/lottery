...
public class LotteryLimit6Utils {
	 
	
	public  static boolean getQuery(Lottery lotterie,int type){
                 Boolean flag=false;
                    if(type==0){
                    	int c=0;
                    ...
                    /*	System.out.println("qi:"+lotterie.getQi()+",号1："+lotterie.getNumber1()+",号二："+lotterie.getNumber2());
                    	...
                    	int c=0;
                    	Integer[] mm=new Integer[6];
                    	mm[0]=0;mm[1]=1;mm[2]=2;mm[3]=3;mm[4]=4;mm[5]=5;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber1()==m){
                    			c++;
                    		}
                    	...
                    	int c=0;
                    	Integer[] mm=new Integer[6];
                    	mm[0]=5;mm[1]=6;mm[2]=7;mm[3]=8;mm[4]=9;mm[5]=0;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber1()==m){
                    			c++;
                    		}
                    	...
                    	int c=0;
                    	Integer[] mm=new Integer[6];
                    	mm[0]=0;mm[1]=1;mm[2]=2;mm[3]=4;mm[4]=5;mm[5]=6;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber1()==m){
                    			c++;
                    		}
                    	...
                    	mm=new Integer[6];
                    	mm[0]=0;mm[1]=1;mm[2]=2;mm[3]=3;mm[4]=4;mm[4]=5;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber2()==m){
                    			c++;
                    		}
                    	...
                    	int c=0;
                    	Integer[] mm=new Integer[6];
                    	mm[0]=2;mm[1]=3;mm[2]=4;mm[3]=5;mm[4]=7;mm[5]=6;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber1()==m){
                    			c++;
                    		}
                    	...
                    	mm=new Integer[6];
                    	mm[0]=0;mm[1]=2;mm[2]=3;mm[3]=5;mm[4]=6;mm[5]=8;
                    	for(Integer m:mm){
                    		if(lotterie.getNumber2()==m){
                    			c++;
                    		}
                    	 ...
                    	 mm[0]=3;mm[1]=4;mm[2]=5;mm[3]=6;mm[4]=8;mm[5]=7;
