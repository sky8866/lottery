...
public class XjsscGuilvKillUtils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,XjsscLotteryService lotteryService, XjsscGuilvKillService guilvService,List<XjsscGuilvKill> sbr,boolean isvip,List<XjsscLottery> lotteries){
		...
		PageView<XjsscGuilvKill> pageViewGuilv = new PageView<XjsscGuilvKill>();
		...
		pageViewGuilv.setQueryResult(guilvService.findList(pageViewGuilv,
				filtersnewses));
		List<XjsscGuilvKill> guilvs = pageViewGuilv.getRecords();
	...
	private static void guilv(int type, int sum, int query, List<XjsscLottery> lotteries,
			List<StringBuffer> sbs, List<XjsscGuilvKill> sbr, List<String> sumVaule,
			int even, int fixation, int matchType, int number,int addition,int buchang,long qi, XjsscGuilvKillService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			List<XjsscLottery> lotteries, List<StringBuffer> sbs, List<XjsscGuilvKill> sbr,
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,long qi, XjsscGuilvKillService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<XjsscLottery> lotteries,
			List<StringBuffer> sbs, List<XjsscGuilvKill> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,long qi, XjsscGuilvKillService guilvService) {
			...
			if (bsum) {
		 	  int countold = setold( e,type,sbs, lotteries,  number,count); 
				...
				if (flag) {
					...
					XjsscGuilvKill vo = new XjsscGuilvKill();
