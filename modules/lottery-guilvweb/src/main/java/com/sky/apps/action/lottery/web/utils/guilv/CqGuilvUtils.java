...
public class CqGuilvUtils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,CqsscLotteryService lotteryService,CqGuilvService guilvService,List<CqGuilv> sbr,boolean isvip,List<CqsscLottery> lotteries){
	...
	private static void guilv(int type, int sum, int query, List<CqsscLottery> lotteries,
			...
			int even, int fixation, int matchType, int number,int addition,int buchang,long qi, CqGuilvService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			...
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,long qi, CqGuilvService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<CqsscLottery> lotteries,
			List<StringBuffer> sbs, List<CqGuilv> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,long qi, CqGuilvService guilvService) {
