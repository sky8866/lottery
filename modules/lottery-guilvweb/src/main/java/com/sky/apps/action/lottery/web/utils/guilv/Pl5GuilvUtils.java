...
public class Pl5GuilvUtils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,Pl5LotteryService lotteryService,Pl5GuilvService guilvService,List<Pl5Guilv> sbr,boolean isvip,List<Pl5Lottery> lotteries){
	...
	private static void guilv(int type, int sum, int query, List<Pl5Lottery> lotteries,
			...
			int even, int fixation, int matchType, int number,int addition,int buchang,long qi, Pl5GuilvService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			...
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,long qi, Pl5GuilvService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<Pl5Lottery> lotteries,
			List<StringBuffer> sbs, List<Pl5Guilv> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,long qi, Pl5GuilvService guilvService) {
