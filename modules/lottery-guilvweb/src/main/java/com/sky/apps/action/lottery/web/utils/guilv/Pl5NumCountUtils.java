...
public class Pl5NumCountUtils {
	...
	public  static void getGuilv(int addition,int buchang,int fixation,int number,Pl5Guilv vo, int sum,String infoString){
	...
	public  static void getGuilvSame(int addition,int buchang,int fixation,int number,Pl5GuilvSameOld vo, int sum,String infoString){
	...
	public  static void getGuilvScope(int addition,int buchang,int fixation,int number,Pl5GuilvScopeOld vo, int sum,String infoString){
