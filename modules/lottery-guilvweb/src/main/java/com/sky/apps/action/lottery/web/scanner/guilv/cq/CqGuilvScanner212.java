...
@Service("CqGuilvScanner212") 
public class CqGuilvScanner212 implements QueryComm{
						...
						for(int type=0;type<=4;type++){ 
							 for(int number=6;number<=6;number++){
								 ...
								 for(int addition=2;addition<=2;addition++){
								    ...
								    CqLotteryUtils.setQuery(addition, buchang, type, CqNumCountUtils.getCount(addition, buchang, 10, number), 10, 1, number, lotteryService, guilvService, sbr,true,cocuntService,conditionService);	
