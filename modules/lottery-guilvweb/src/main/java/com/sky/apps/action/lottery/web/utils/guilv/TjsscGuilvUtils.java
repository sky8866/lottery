...
public class TjsscGuilvUtils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,TjsscLotteryService lotteryService,TjsscGuilvService guilvService,List<TjsscGuilv> sbr,boolean isvip,List<TjsscLottery> lotteries){
	...
	private static void guilv(int type, int sum, int query, List<TjsscLottery> lotteries,
			List<StringBuffer> sbs, List<TjsscGuilv> sbr, List<String> sumVaule,
			int even, int fixation, int matchType, int number,int addition,int buchang,long qi, TjsscGuilvService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			List<TjsscLottery> lotteries, List<StringBuffer> sbs, List<TjsscGuilv> sbr,
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,long qi, TjsscGuilvService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<TjsscLottery> lotteries,
			List<StringBuffer> sbs, List<TjsscGuilv> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,long qi, TjsscGuilvService guilvService) {
