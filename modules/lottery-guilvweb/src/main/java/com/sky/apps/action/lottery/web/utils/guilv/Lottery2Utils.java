...
public class Lottery2Utils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,LotteryService lotteryService,GuilvService guilvService,List<Guilv> sbr,boolean isvip){
	...
	private static void guilv(int type, int sum, int query, List<Lottery> lotteries,
			...
			int even, int fixation, int matchType, int number,int addition,int buchang,int qi, GuilvService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			...
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,int qi, GuilvService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<Lottery> lotteries,
			List<StringBuffer> sbs, List<Guilv> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,int qi, GuilvService guilvService) {
