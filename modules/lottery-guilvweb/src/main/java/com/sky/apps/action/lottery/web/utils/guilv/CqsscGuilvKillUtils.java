...
public class CqsscGuilvKillUtils {
	...
	public  static void setQuery(int addition,
			 ...
			 int fixation,
			  int matchType,
			 int number,CqsscLotteryService lotteryService, CqsscGuilvKillService guilvService,List<CqsscGuilvKill> sbr,boolean isvip,List<CqsscLottery> lotteries){
		...
		PageView<CqsscGuilvKill> pageViewGuilv = new PageView<CqsscGuilvKill>();
		...
		pageViewGuilv.setQueryResult(guilvService.findList(pageViewGuilv,
				filtersnewses));
		List<CqsscGuilvKill> guilvs = pageViewGuilv.getRecords();
	...
	private static void guilv(int type, int sum, int query, List<CqsscLottery> lotteries,
			List<StringBuffer> sbs, List<CqsscGuilvKill> sbr, List<String> sumVaule,
			int even, int fixation, int matchType, int number,int addition,int buchang,int qi, CqsscGuilvKillService guilvService) {
	...
	private static void getFixation(int type, int sum, int query,
			List<CqsscLottery> lotteries, List<StringBuffer> sbs, List<CqsscGuilvKill> sbr,
			List<String> sumVaule, int even, int e, int matchType, int number,int addition,int buchang,int qi, CqsscGuilvKillService guilvService) {
		int z = s(sum);
		int x = z + e;
	...
	private static void one(int x, int type, int query, List<CqsscLottery> lotteries,
			List<StringBuffer> sbs, List<CqsscGuilvKill> sbr, List<String> sumVaule,
			int even, int e, int matchType, int number,int addition,int buchang,int qi, CqsscGuilvKillService guilvService) {
			...
			if (bsum) {
		 	  int countold = setold( e,type,sbs, lotteries,  number,count); 
				...
				if (flag) {
					...
					CqsscGuilvKill vo = new CqsscGuilvKill();
