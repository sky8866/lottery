...
@Service("Pl5GuilvPeerScanner3")
public class Pl5GuilvPeerScanner3 implements QueryComm {
	...
	@Autowired
	private Pl5GuilvPeerOldService peerOldService;
	@Autowired Pl5GuilvRemoveConditionService  conditionsService;
	public void job() {
		  System.out.println("p5_peer_2");
						...
						for(int type=0;type<=3;type++){
							 for(int number=0;number<=1;number++){
						           ...
						           List<Pl5GuilvPeerOld> sbr=new ArrayList<Pl5GuilvPeerOld>();
						            ...
						            Pl5LotteryPeerUtils.setQuery(addition, b, type, count, 0, 1, number, lotteryService, peerOldService, sbr, true,    guilvRemoveCountService,conditionsService);
