...
public class CqNumCountUtils {
	...
	public  static void getGuilv(int addition,int buchang,int fixation,int number,CqGuilv vo, int sum,String infoString){
	...
	public  static void getGuilvSame(int addition,int buchang,int fixation,int number,CqGuilvSameOld vo, int sum,String infoString){
	...
	public  static void getGuilvScope(int addition,int buchang,int fixation,int number,CqGuilvScopeOld vo, int sum,String infoString){
